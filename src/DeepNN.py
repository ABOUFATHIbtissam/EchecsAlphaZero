...
class DeepNN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(101, 256, kernel_size=3, stride=1, padding=1) #(12+1)*8+7 = 119
        ...
        self.residual_blocks = nn.ModuleList([
            nn.Sequential(
                ...
                nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1),
                nn.BatchNorm2d(256)
            ) for _ in range(19)  #20 residual blocks /// ou 40 à voir
        ])
        ...
        self.policy_fc = nn.Linear(2 * 8 * 8, 4672)  #2 canaux de sortie, 4672 : approximation nombre de coups possibles
